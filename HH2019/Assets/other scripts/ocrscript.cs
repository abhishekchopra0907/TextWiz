...
public class ocrscript : MonoBehaviour
{
    ...
    public void startocr()
    {
        ...
        //last step after button pressing
        Debug.Log("capture");
    ...
    */
    ...
    void TextOcr(AnnotateImageResponses responses)
    {
        ...
        if (responses.responses.Count > 0)
        {
            ...
            {
                Debug.Log("results not empty");
                ocrtext += responses.responses[0].textAnnotations[0].description;

            }
        }
        Debug.Log("data:" + ocrtext);
        string FILE_PATH = Application.persistentDataPath + "/ocrtext.txt";

        //loadAndDisplayImages.seperateUrlsAndDownload(ocrtext);
       

        if (File.Exists(FILE_PATH))
        {
            StreamWriter st = new StreamWriter(FILE_PATH, false);
            st.Write(ocrtext);
            st.Close();
        }
        ...
        post.PostData(ocrtext);
        //tmp.text = File.ReadAllText(Application.persistentDataPath + "/ocrtext.txt");
        //Debug.Log(Application.persistentDataPath + "/ocrtext.txt");
        //web request coroutine here
